/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env --config apps/user-application/wrangler.jsonc` (hash: bb9506cbc4dc20fb490caba76446c272)
// Runtime types generated with workerd@1.20251217.0 2026-06-25 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./apps/user-application/src/server");
	}
	interface Env {
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LYRIC_VIDEO_TRANSCRIPTION_PROVIDER" | "LYRIC_VIDEO_MAX_AUDIO_BYTES" | "LYRIC_VIDEO_DAILY_TRANSCRIPTION_LIMIT" | "LYRIC_VIDEO_MAX_DURATION_SECONDS">> {}
}
